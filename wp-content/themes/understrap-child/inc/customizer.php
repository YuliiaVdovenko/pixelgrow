...
if ( ! function_exists( 'customize_contact_register' ) ) {
	function customize_contact_register($wp_customize)
	{
		...
		$wp_customize -> add_setting('address_str', array(
			'default' => '',
		));
		...
		$wp_customize -> add_control(
			new WP_Customize_Control(
				...
				'address_str', array(
					'type'=>'text',
					'label' => __('Custom address (str)'),
					'section' => 'contact_text_section',
					'settings' => 'address_str',
				)));


		$wp_customize -> add_setting('address_ind', array(
			'default' => '',
		));
		...
		$wp_customize -> add_control(
			new WP_Customize_Control(
				...
				'address_ind', array(
					'type'=>'text',
					'label' => __('Custom address (ind)'),
					'section' => 'contact_text_section',
					'settings' => 'address_ind',
				)));

		

		$wp_customize -> add_setting('address_country_ua', array(
			'default' => ''
		));
		...
		$wp_customize -> add_control(
			new WP_Customize_Control(
				$wp_customize,
				'address_country_ua', array(
					'type'=>'text',
					'label' => __("Custom address"),
					'section' => 'contact_text_section',
					'settings' => 'address_country_ua',
				)));

		$wp_customize -> add_setting('address_str_ua', array(
			'default' => '',
		));
		...
		$wp_customize -> add_control(
			new WP_Customize_Control(
				$wp_customize,
				'address_str_ua', array(
					'type'=>'text',
					'label' => __('Custom address (str)'),
					'section' => 'contact_text_section',
					'settings' => 'address_str_ua',
				)));


		$wp_customize -> add_setting('address_ind_ua', array(
			'default' => '',
		));
		...
		$wp_customize -> add_control(
			new WP_Customize_Control(
				$wp_customize,
				'address_ind_ua', array(
					'type'=>'text',
					'label' => __('Custom address (ind)'),
					'section' => 'contact_text_section',
					'settings' => 'address_ind_ua',
				)));
